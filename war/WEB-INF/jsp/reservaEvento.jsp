...
<body>
	...
	<form action="saveReserva" id="reservarevento" onsubmit="return validar();">
		<div id="formulario">
			<div class="row">
				<div id="columna1">
			...
			<div class="row">
				...
				<div id="columna2"><p>
					<input type="radio" name="tipo" value="publico">NORMAL <br>
					<input type="radio" name="tipo" value="intermedio">PLATINIUM<br>
						<input type="radio" name="tipo" value="exclusivo">VIP
					</p>
				</div>
			</div>
			<div class="row">
