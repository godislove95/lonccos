...
<div id="cero">
			...
			<div id="table">
				...
				<div class="cell"><select name="tipo" id="tipo">
								<option value="ad_entrada">Entradas</option>
								<option value="ad_sopa">Sopas</option>
								<option value="ad_ensalada">Ensaladas</option>
								<option value="ad_postre">Postres</option>
								<option value="ad_fondo">Platos de fondo</option>
								<option value="ad_extra">Extras</option>
								</select>
								</div>	
				</div>
				<div class="row">
