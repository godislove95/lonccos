...
public class SaveImagenBebida extends HttpServlet {
 ...
 public void doPost(HttpServletRequest req, HttpServletResponse resp)
	 ...
	 List<Bebida> bebidas=(List<Bebida>)q.execute(Long.parseLong(id));
	 if(bebidas.size()==0){
	      resp.sendRedirect("/error.jsp");
          return ;
	 }
	 bebidas.get(0).setImg(blobKeys.get(0).getKeyString());
	 System.out.println(bebidas.get(0).toString());
